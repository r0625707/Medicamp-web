...
class GroepForm extends React.Component {
    ...
    postData() {
        axios.post("https://medicamp-so.appspot.com/api/groep/" + localStorage.getItem('login') + "/", {
    ...
    render() {
        return (
            <div>
                <Button onClick={this.toggle} color="success" style={{ cursor: 'pointer' }}>Groep registreren</Button>
                <Modal isOpen={this.state.modal} toggle={this.toggle}>
                    <ModalHeader toggle={this.toggle}>Groep registreren</ModalHeader>
                    <ModalBody>
                        <Form>
                            <FormGroup>
                ...
                <Modal isOpen={this.state.error} toggle={this.toggleError}>
                    ...
                    <ModalBody>
                        <p>Er ging iets mis bij het aanmaken van de groep.</p>
